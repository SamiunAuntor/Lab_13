...
public class Customer {
    ...
    public void addNewCustomer() {
        ...
        CustomerData data = inputCustomerData(read); // Extract Method, Replace data value with object
    ...
    private CustomerData inputCustomerData(Scanner read) {
        ...
        return new CustomerData(name, email, password, phone, address, age); // Replace data value with object
    }
